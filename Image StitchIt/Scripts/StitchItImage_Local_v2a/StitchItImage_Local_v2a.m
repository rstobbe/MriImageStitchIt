...
function [SCRPTipt,SCRPTGBL,err] = StitchItImage_Local_v2a(SCRPTipt,SCRPTGBL)
...
IMG.datafunc = SCRPTGBL.CurrentTree.('Datafunc').Func;
IMG.reconfunc = SCRPTGBL.CurrentTree.('Reconfunc').Func;

%---------------------------------------------
% Get Working Structures from Sub Functions
%---------------------------------------------
STCHDATAipt = SCRPTGBL.CurrentTree.('Datafunc');
if isfield(SCRPTGBL,('Datafunc_Data'))
    STCHDATAipt.Datafunc_Data = SCRPTGBL.Datafunc_Data;
end
...
%------------------------------------------
func = str2func(IMG.datafunc); 
DataObj = func();
[SCRPTipt,SCRPTGBL,STCHDATA,err] = DataObj.InitViaCompass(SCRPTipt,SCRPTGBL,STCHDATAipt);
if err.flag
    return
end
...
[IMG,err] = ReconObj.CreateImage(STCHDATA.DATA);
if err.flag
    return
end
