...
classdef CpsReconNufftRetChanV1b < handle
...
% Constructor
%==================================================================  
function obj = CpsReconNufftRetChanV1b()              
end
...
function InitViaCompass(obj,Reconipt)    
    ...
    if strcmp(Reconipt.('ObjectAtIso'),'Yes')
...
function [Interface] = CompassInterface(obj,SCRPTPATHS)    
    ...
    m = m+1;
    Interface{m,1}.entrytype = 'Choose';
    Interface{m,1}.labelstr = 'ObjectAtIso';
