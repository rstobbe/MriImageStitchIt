...
classdef ReconLungNufftBasicV1c < handle
...
% Constructor
%==================================================================  
function obj = ReconLungNufftBasicV1c()              
end
...
function InitViaCompass(obj,Reconipt)    
    ...
    file = Reconipt.('TrajMash_File').Struct.filename;
    obj.Recon.SetTrajMash(file);
...
function [Interface] = CompassInterface(obj,SCRPTPATHS)    
    ...
    m = m+1;
    Interface{m,1}.entrytype = 'RunExtFunc';
    Interface{m,1}.labelstr = 'TrajMash_File';
    Interface{m,1}.entrystr = '';
    Interface{m,1}.buttonname = 'Load';
