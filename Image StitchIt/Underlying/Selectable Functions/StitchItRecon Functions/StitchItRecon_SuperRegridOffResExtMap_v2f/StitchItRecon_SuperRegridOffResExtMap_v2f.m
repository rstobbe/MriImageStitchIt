%==================================================================
% (v2f)
%   - start:  StitchItRecon_SuperRegridOffRes_v2f
%==================================================================

classdef StitchItRecon_SuperRegridOffResExtMap_v2f < handle

properties (SetAccess = private)                   
    Method = 'StitchItRecon_SuperRegridOffResExtMap_v2f'
    BaseMatrix
    PreScaleRxChans
    AcqInfo
    AcqInfoRxp
...
% Constructor
%==================================================================  
function RECON = StitchItRecon_SuperRegridOffResExtMap_v2f()              
end
