%==================================================================
% (v2b)
%   - as StitchItRecon_WaveletOffRes_v2b
%==================================================================

classdef StitchItRecon_WaveletOffRes_v2b < handle

properties (SetAccess = private)                   
    Method = 'StitchItRecon_WaveletOffRes_v2b'
    BaseMatrix
    Fov2Return
    AcqInfo
    AcqInfoRxp
...
% Constructor
%==================================================================  
function RECON = StitchItRecon_WaveletOffRes_v2b()              
end
...
function [IMG,err] = CreateImage(RECON,DataObj)     
    ...
    elseif strcmp(RECON.RxProfSel,'Actual') 
        ...
        if isempty(RxProfs)
            err.flag = 1;
            err.msg = 'No Actual RfProf Available';
            return
        end
    end
