%==================================================================
% (v2b)
%   - As StitchItRecon_SuperRegridPreWgt_v2a
%==================================================================

classdef StitchItRecon_SuperRegridOffResImages_v2b < handle

properties (SetAccess = private)                   
    Method = 'StitchItRecon_SuperRegridOffResImages_v2b'
    BaseMatrix
    Fov2Return
    PreScaleRxChans
    AcqInfo
...
% Constructor
%==================================================================  
function RECON = StitchItRecon_SuperRegridOffResImages_v2b()              
end
...
function InitViaCompass(RECON,RECONipt)    
    ...
    RECON.AcqInfo = RECONipt.([CallingLabel,'_Data']).('Recon_File_Data').WRT.STCHOR;
...
function [IMG,err] = CreateImage(RECON,DataObj)     
    ...
    if not(strcmp(RECON.PreScaleRxChans,'No'))
        ...
        Data = DataObj.ReturnDataSet(RECON.AcqInfo{1},1);        
        ...
        StitchIt.Initialize(RECON.AcqInfo{1},DataObj.RxChannels); 
    ...
    NameSuffix = 'SuperRegridOffResImages';
    IMG = AddCompassInfo(Image,DataObj,RECON.AcqInfo{1},StitchIt,PanelOutput,NameSuffix);
