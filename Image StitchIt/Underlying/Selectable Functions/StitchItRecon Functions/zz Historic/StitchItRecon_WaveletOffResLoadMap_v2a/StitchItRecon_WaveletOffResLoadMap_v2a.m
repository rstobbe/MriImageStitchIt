...
classdef StitchItRecon_WaveletOffResLoadMap_v2a < handle

properties (SetAccess = private)                   
    Method = 'StitchItRecon_WaveletOffResLoadMap_v2a'
    BaseMatrix
    Fov2Return
    AcqInfo
    AcqInfoRxp
...
% Constructor
%==================================================================  
function RECON = StitchItRecon_WaveletOffResLoadMap_v2a()              
end
