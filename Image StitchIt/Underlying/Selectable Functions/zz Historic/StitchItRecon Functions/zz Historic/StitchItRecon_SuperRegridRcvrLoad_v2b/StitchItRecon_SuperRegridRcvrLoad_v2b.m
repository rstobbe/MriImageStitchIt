%==================================================================
% (v2b)
%   - As StitchItRecon_SuperRegridRcvrLoad_v2b
%==================================================================

classdef StitchItRecon_SuperRegridRcvrLoad_v2b < handle

properties (SetAccess = private)                   
    Method = 'StitchItRecon_SuperRegridRcvrLoad_v2b'
    BaseMatrix
    PreScaleRxChans
    AcqInfo
    AcqInfoRxp
...
% Constructor
%==================================================================  
function RECON = StitchItRecon_SuperRegridRcvrLoad_v2b()              
end
...
function InitViaCompass(RECON,RECONipt)    
    ...
    RECON.Rcvrs = single(RECONipt.([CallingLabel,'_Data']).('Rcvrs_File_Data').IMG.Im(:,:,:,6:end));            % should be index 
end
