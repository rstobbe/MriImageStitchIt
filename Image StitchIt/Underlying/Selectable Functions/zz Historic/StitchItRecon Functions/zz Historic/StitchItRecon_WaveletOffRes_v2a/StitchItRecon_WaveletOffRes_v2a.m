...
classdef StitchItRecon_WaveletOffRes_v2a < handle

properties (SetAccess = private)                   
    Method = 'StitchItRecon_WaveletOffRes_v2a'
    BaseMatrix
    Fov2Return
    AcqInfo
    AcqInfoRxp
...
% Constructor
%==================================================================  
function RECON = StitchItRecon_WaveletOffRes_v2a()              
end
...
function [IMG,err] = CreateImage(RECON,DataObj)     
    ...
    %---
    OffResMap = zeros(size(Image0),'single');
    %---
